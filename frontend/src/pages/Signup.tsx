...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-bg relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-accent-blue/10 blur-[120px] mix-blend-screen pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-accent-purple/10 blur-[120px] mix-blend-screen pointer-events-none" />
      ...
      <div className="w-full max-w-[420px] p-6 relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="font-display text-[28px] font-bold tracking-tight text-text">Create account</h1>
          <p className="text-text-dim text-[14.5px] mt-1.5">Start your compliance journey today</p>
        </div>
        ...
        <Card className="p-8 backdrop-blur-xl bg-surface/60 border-border/50">
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5 mt-1">
              <label className="text-[13px] font-medium text-text-dim ml-1">Work Email</label>
              <div className="relative">
                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-text-faint">
                  <Mail size={16} />
                </div>
            ...
            <div className="flex flex-col gap-1.5 mt-1">
              <label className="text-[13px] font-medium text-text-dim ml-1">Password</label>
              <div className="relative">
                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-text-faint">
                  <Lock size={16} />
                </div>
            ...
            <button 
              ...
              className="mt-4 w-full bg-grad-primary text-white hover:opacity-90 flex items-center justify-center gap-2 py-2.5 rounded-[10px] font-medium text-[14px] transition-all disabled:opacity-70 disabled:cursor-not-allowed group shadow-lg shadow-accent-blue/20"
            >
          ...
          <div className="mt-8 text-center text-[13.5px] text-text-dim">
            ...
            <Link to="/login" className="text-text font-medium hover:text-accent-blue transition-colors">
              Sign in
            </Link>
          </div>
        </Card>
