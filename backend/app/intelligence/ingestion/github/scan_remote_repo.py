...
Usage:
    python -m app.intelligence.ingestion.github.scan_remote_repo <owner/repo> [--ref main] [--yes]
...
def main():
    ...
    if not args.yes:
        ...
        if answer != "y":
            print("Stopped before classifying. Re-run with --yes to skip this prompt.")
            return
    ...
    print("\n=== Data types found ===")
    data_types = Counter(c["data_type"] for c in confirmed if c.get("data_type"))
    ...
    print("This is a code-side inventory only — it does NOT check whether your privacy "
